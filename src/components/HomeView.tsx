    ...
    <div className="flex flex-col gap-6 pb-32 bg-[#FAFBFF] font-sans">
      ...
      <section className="px-5 space-y-2.5">
        ...
        <div className="flex justify-between gap-1.5 overflow-hidden">
          ...
          <ExploreCard icon={<CreditCard size={14} fill="white" className="text-white" />} label="Pay" sub="Fee" onClick={() => setActiveTab('payments')} iconBg="bg-orange-500" />
          ...
          <ExploreCard icon={<MessageCircle size={14} fill="white" className="text-white" />} label="Help" sub="Support" onClick={() => setActiveTab('support')} iconBg="bg-blue-500" />
        </div>
      </section>
